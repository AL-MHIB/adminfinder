...
print "if you have any suggestions please contact me";
...
print "
        ...
        |  Developer are not responsible for any damage caused by this   | 
        ...
        |  Github  :     https://github.com/AL-MHIB                      | 

        |  Website :             smmmax.shop/                            | 

        |  instagram :   :  www.instagram.com/d9p0/                      | 

        ╘────────────────────────────────────────────────────────────────╝  

";

print " Please Add Website Target :) :) :) \n Example: www.smmmax.shop \n-> ";
...
@path=('admin/','wp-login.php','administrator/','admin1/','admin2/','admin3/','admin4/','admin5/','usuarios/', '/acces_web/','usuario/','administrator/','moderator/','webadmin/','adminarea/','bb-admin/','adminLogin/','admin_area/','panel-administracion/','instadmin/',
...
'adm/index.brf','adm.brf','affiliate.brf','adm_auth.brf','memberadmin.brf','administratorlogin.brf','administrator_login.aspx','inhome.aspx','adminhome.asp','admin.aspx','admin.asp','admin.php',

'admin.php','administrator/','admin_area/','admin/index.php','admin/login.php','joomla/administrator','admin_area/admin.php','instadmin/','panel-administracion/','bb-admin/','adminarea/','webadmin/','moderator/','admin/home.php','affiliate.php','adm/index.html','bb-admin/admin.html','rcjakar/admin/login.php','moderator.html','admin/controlpanel.html','pages/admin/admin-login.html','account.php','cp.html','admin/adminLogin.php','panel-administracion/login.php','panel-administracion/index.php','panel-administracion/admin.php','modelsearch/index.php','modelsearch/admin.php','admincontrol/login.php','adm/admloginuser.php','admloginuser.php','admin2.php','admin2/login.php','admin2/index.php'
...
print " \n #almheb: [+] Ow ! Found => $findall\n\n";

}else{

print "#almheb find:[-] Not Found <- $findall\n";
...
print "
         ...
         |  Developers are not responsible for any damage caused by this  | 
         ...
         |  Youtube :    https://youtube.com/c/%D8%B4%D8%B1%D9%88%D8%AD%D8%A7%D8%AA%D8%A7%D9%84%D9%85%D9%87%D9%8A%D8%A8                     | 

         |  Website :        smmmax.shop/                           | 

         |  insta   :  https://www.instagram.com/d9p0/                    | 
